...
const int MAX_BALL_DETECTION_THRESHOLD = 45;	// Maximum distance to register a detected ball bearing
...
const int MIN_BALL_CLOSE_RANGE_THRESHOLD = 3;	// Minimum distance to start ball bearing pick-up process
...
const int DETECTION_PERSISTENCE = 500;			// Period in milliseconds to register a detected bearing
