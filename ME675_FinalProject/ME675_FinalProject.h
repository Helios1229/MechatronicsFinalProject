...
const int MAX_BALL_DETECTION_THRESHOLD = 15;	// Maximum distance to register a detected ball bearing
...
const int MAGNET_POWER_ON_DELAY = 350;			// Period in milliseconds to power on magnet and lift ball
const int DETECTION_PERSISTENCE = 5000;			// Period in milliseconds to register a detected bearing
